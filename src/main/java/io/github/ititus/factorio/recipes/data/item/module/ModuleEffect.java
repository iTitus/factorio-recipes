...
public final class ModuleEffect implements Printable {
    ...
    public static final ModuleEffect NO_EFFECT = new ModuleEffect(BigRationalConstants.ZERO, BigRationalConstants.ZERO, BigRationalConstants.ZERO, BigRationalConstants.ZERO);
    ...
    private ModuleEffect(BigRational consumptionBonus, BigRational productivityBonus, BigRational pollutionBonus, BigRational speedBonus) {
    ...
    public static class Builder {
        ...
        private BigRational consumptionBonus = BigRationalConstants.ZERO, productivityBonus = BigRationalConstants.ZERO, pollutionBonus = BigRationalConstants.ZERO, speedBonus = BigRationalConstants.ZERO;
    ...
    public ModuleEffect multiply(BigRational r) {
        return new ModuleEffect(consumptionBonus.multiply(r).max(BigRationalConstants.MINUS_FOUR_OVER_FIVE), productivityBonus.multiply(r), pollutionBonus.multiply(r), speedBonus.multiply(r));
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(consumptionBonus, that.consumptionBonus) && Objects.equals(productivityBonus, that.productivityBonus) && Objects.equals(pollutionBonus, that.pollutionBonus) && Objects.equals(speedBonus, that.speedBonus);
    }
